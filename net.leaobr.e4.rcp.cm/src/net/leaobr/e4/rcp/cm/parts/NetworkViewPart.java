...
public class NetworkViewPart implements ITreeContentProvider {
	...
	public void createControls(Composite parent) {
		...
		searchBtn.setText("...");
		searchBtn.addSelectionListener(new SearchListener(parent));
		FormData fData = new FormData();
		fData = new FormData();
		fData.top = new FormAttachment(0);
		fData.bottom = new FormAttachment(0, 35);
	...
	class ViewLabelProvider extends LabelProvider {
		...
		public String getText(Object element) {
			return super.getText(element); //TODO
		}
	...
	class SearchListener implements SelectionListener {

		private final Composite parent;

		public SearchListener(Composite parent) {
			this.parent = parent;
		}
